  ...
  return (
    <div className="page">
      ...
      <div style={{ padding: '0 16px 32px' }}>
        ...
        <ol style={olStyle}>
          <li style={liStyle}>회원은 언제든지 앱 내 설정 화면 또는 운영자 이메일을 통해 탈퇴를 요청할 수 있으며, 운영자는 지체 없이 이를 처리합니다.</li>
          <li style={liStyle}>회원 탈퇴 시 회원의 모든 게임 데이터(어항·물고기·재화·도감 등)는 30일 이내에 영구 삭제되며, 복구되지 않습니다.</li>
